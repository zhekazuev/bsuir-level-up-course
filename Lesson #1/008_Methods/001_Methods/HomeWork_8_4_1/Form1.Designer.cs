namespace HomeWork_8_4_1
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(113, 89);
			...
			// textBox2
			// 
			this.textBox2.Location = new System.Drawing.Point(551, 92);
			...
			this.button1.Text = "Остаток от деления";
			...
			this.button2.Text = "Степень";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(551, 140);
			this.button3.Name = "button3";
			this.button3.Size = new System.Drawing.Size(119, 42);
			this.button3.TabIndex = 5;
			this.button3.Text = "Конкастенация";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(551, 219);
